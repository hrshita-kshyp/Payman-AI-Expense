...
function setShims(shims, options = { auto: false }) {
    if (exports.auto) {
        throw new Error(`you must \`import 'paymanai/shims/${shims.kind}'\` before importing anything else from paymanai`);
    }
    if (exports.kind) {
        throw new Error(`can't \`import 'paymanai/shims/${shims.kind}'\` after \`import 'paymanai/shims/${exports.kind}'\``);
    }
